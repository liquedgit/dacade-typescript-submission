...
import { idlFactory } from './finance_reminder.did.js';
export { idlFactory } from './finance_reminder.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FINANCE_REMINDER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./finance_reminder.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the finance_reminder canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./finance_reminder.did.js")._SERVICE>}
 */
export const finance_reminder = createActor(canisterId);
